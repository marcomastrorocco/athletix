...
export const metadata: Metadata = {
  title: "Youth Speed Foundation — ATHLETIX Brisbane",
  description:
    "Learn the foundations of sprinting and acceleration for Primary School aged kids (7–11). Perfect the mechanics and improve speed — the pathway to our Speed Development class.",
};
  ...
  },
  {
    ...
    a: (
      <p>
        ...
        <Link href="/youth-speed-development">
