...
export const metadata: Metadata = {
  title: "Youth Strength Training Class Brisbane — ATHLETIX Gym",
  description:
    "Youth Strength Development (12–16 yrs). Teens learn the foundations of strength and resistance training through a criteria-based, sequential program at ATHLETIX Brisbane.",
};
